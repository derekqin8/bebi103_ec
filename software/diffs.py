...
bokeh.io.output_file('../interactives/interactive_diffs.html')
...
diff_gamma = bebi103.viz.predictive_ecdf(
    samples=gamma_samples, data=x, diff='ecdf', x_axis_label="n"
)

diff_tabs.append(bokeh.models.widgets.Panel(
    child=diff_gamma,
    title='Gamma Model'
))

diff_exp2 = bebi103.viz.predictive_ecdf(
    samples=exp2_samples, data=x, diff='ecdf', x_axis_label="n"
)
...
bokeh.io.save(bokeh.models.widgets.Tabs(tabs=diff_tabs))
# %%
